	                    ...
	                    <li class="li1">
	                        <dl>
	                            <a href="detail?id=${item.good.id}">
	                                ...
	                                <dd class="goodsname" style="padding-top: 36px;">${item.good.gname}</dd>
	                                <dd class="goods-des">${item.good.intro}</dd>
	                            </a>
	                        </dl>
	                    </li>
	                    <li class="li3">￥<span>${item.good.price}</span></li>
	                    <li class="li4">x<span>${item.amount}</span></li>
	                    <li class="li5">￥<span>${item.good.price * item.amount}</span></li>
	                </ul>
				</c:forEach>
			</div>
