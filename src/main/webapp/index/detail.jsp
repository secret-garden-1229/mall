...
<body>
	...
	<div id="main" class="main">
		...
		<div id="mnav" style="background: #f6f6f6;border: 1px solid #eee;">
			<a href="type?id=${good.typeId}"><span style="color:#ff852b;">${good.type.tname}</span></a>
		...
		<div class="main-left clearfix" style="padding:40px 0;">
			...
			<div class="goodscont">
				<div class="goodsname">${good.gname}</div>
					...
					<div class="goodspage">
						<c:forEach items="${todayList}" var="good">
							<div class="goods">
								...
								<a href="detail?id=${good.id}"><p class="goodsname">${good.gname}</p></a>
							</div>
						</c:forEach>
					</div>
				</div>
